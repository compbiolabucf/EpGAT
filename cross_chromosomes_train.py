...
def cchrs_exp(args):
    ...
    all_gene_nms = {}
    for chr in chrs:
        mats, inds, preds, adj_mats, ws, gene_nms = get_data(cell_line, chr, 32)
    ...
    save_dir = f'cchrs_saves/{event}/{cell_line}_saved_model'
    ...
    for chr in ts_chrs:
        ...
        corr_result.to_csv(f'cchrs_saves/{event}/chr{chr}_result.csv')
